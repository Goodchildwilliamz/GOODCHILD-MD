...
ezra({
  ...
  try {
    if (!_0x8621a4 || _0x8621a4.length === 0) {
      return _0x2e61d5("Example Usage: .code 255763755xxxx.");
    }
    await _0x2e61d5("*Wait Goodchild-md is generating your pair code ✅...*");
    const _0x386b0a = encodeURIComponent(_0x8621a4.join(" "));
    const _0x1ea92d = "https://goodchild.onrender.com/code?number=" + _0x386b0a;
