...
const { format } = require(__dirname + "/../goodchild/mesfonctions");
const os = require('os');
...
const fetchGitHubStats = async () => {
    try {
        const response = await axios.get("https://api.github.com/repos/Goodchildwilliamz/GOODCHIM-MD");
...
ezra({ nomCom: "menu", aliases: ["liste", "helplist", "commandlist"], categorie: "system" }, async (message, client, config) => {
    ...
    moment.tz.setDefault("Africa/Mwanza");
