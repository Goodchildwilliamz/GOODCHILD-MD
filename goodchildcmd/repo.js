...
const fetchGitHubStats = async () => {
    try {
        const response = await axios.get("https://api.github.com/repos/Goodchildwilliamz/GOODCHILD-MD");
...
ezra({
    ...
    try {
        ...
        if (repoData) {
            ...
            *This is ${conf.BOT}*
            the best bot in the universe developed by ${conf.OWNER_NAME}. Fork and give a star 🌟 to my repo please!
     ╭═════┈┈┈═══════┈┈
