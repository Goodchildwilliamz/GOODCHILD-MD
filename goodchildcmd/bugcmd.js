...
// bug database
const { bugtext1 } = require("../goodchild/goodchild/bugtext1");
const { bugtext2 } = require("../goodchild/goodchild/bugtext2");
const { bugtext3 } = require("../goodchild/goodchild/bugtext3");
const { bugtext4 } = require("../goodchild/fgoodchild/bugtext4");
const { bugtext5 } = require("../goodchild/goodchild/bugtext5");
const { bugtext6 } = require("../goodchild/goodchild/bugtext6");
const { bugpdf } = require("../goodchild/goodchild/bugpdf.js");
                        ...
                        dest,
                        {
                            ...
                            contextInfo: {
                                ...
                                externalAdReply: {
                                    ...
                                    previewType: "PHOTO",
                                    sourceUrl:
                                        "https://whatsapp.com/255763755563",
                                    mediaType: 1,
