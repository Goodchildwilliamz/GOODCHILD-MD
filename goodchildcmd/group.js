...
//const { getGroupe } = require("../goodchilddatabase/groupe")
const { Sticker, StickerTypes } = require('wa-sticker-formatter');
const {ajouterOuMettreAJourJid,mettreAJourAction,verifierEtatJid} = require("../goodchilddatabase/antilien")
const {atbajouterOuMettreAJourJid,atbverifierEtatJid} = require("../goodchilddatabase/antibot")
const { search, download } = require("aptoide-scraper");
const fs = require("fs-extra");
const conf = require("../set");
const { default: axios } = require('axios');
//const { uploadImageToImgur } = require('../goodchild/imgur');
