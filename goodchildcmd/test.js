...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=255763755563:+255763755563\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
const templateButtons = [
    ...
    {index: 2, callButton: {displayText: 'Call me!', phoneNumber: '255763755563'}},
...
const sections = [
    ...
    },
   {
	...
	rows: [
	    ...
	    {title: "Option 4", rowId: "option4", description: "This is a description Goodchild Md"}
	]
    },
]
